module parameters
	...
	integer, parameter :: TimeInterval=300000, MaxTime=3900001,CycleRecord=1000	!number of interval for each txt output
    ...
    real(kind=8), parameter::fc=1E6		!constant frequency
