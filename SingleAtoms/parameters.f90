module parameters
	...
	integer, parameter :: NoOfAtoms=13         !No of atoms to be added to simulation
	integer, parameter :: SizeAsIsland=10
	integer, parameter :: TimeInterval=1E5, MaxTime=1E7+1,CycleRecord=1000	!number of interval for each txt output
